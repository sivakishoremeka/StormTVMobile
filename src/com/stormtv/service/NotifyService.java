...
import com.stormtv.mobile.IPTVActivity;
import com.stormtv.mobile.R;
...
public class NotifyService extends Service {
	...
	public static final String INTENT_NOTIFY = "com.stormtv.service.INTENT_NOTIFY";
	...
	private void showNotification(Intent intent) {
		...
		CharSequence text = intent.getStringExtra("PROG")
				+ " is starting. Watch Now.";
		...
		PendingIntent contentIntent = PendingIntent.getActivity(
				this,
				0,
				new Intent(this, IPTVActivity.class)
						.putExtra("PROG", intent.getStringExtra("PROG"))
						.putExtra("CHANNELNAME",
								intent.getStringExtra("CHANNELNAME"))
						.putExtra("URL", intent.getStringExtra("URL"))
						.putExtra("CHANNELID",
								intent.getStringExtra("CHANNELID")), 0);
